...
import { Clock, PlusCircle, Video, PlayCircle, ChevronRight, LogOut, Trash2, X } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <>
      ...
      {/* Sidebar Content */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-72 bg-slate-900 text-slate-300 flex flex-col h-full border-r border-slate-800 transition-transform duration-300 ease-in-out
